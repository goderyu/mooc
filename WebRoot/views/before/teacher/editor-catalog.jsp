...
<div class="wrap">
	...
	<script type="text/javascript">
		...
		$(".selected").click(function(){
			...
			top.ltop.location="/mooc/before/editor/editortop?state="+state+"&catalogid="+catalogid;
			top.down.location="/mooc/before/editor/wangeditor?state="+state+"&catalogid="+catalogid;
		})
